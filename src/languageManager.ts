...
const TEXT_MAP = {
    'zh-cn': {
        ...
        'webview.bodyMode.mockTooltip': '首次会从配置的 Swagger 地址拉取并写入缓存；后续优先读取缓存生成 Query / Body / FormData Mock 数据',
    ...
    'en': {
        ...
        'webview.bodyMode.mock': 'Mock',
        'webview.bodyMode.mockTooltip': 'First run fetches from the configured Swagger URL and writes cache; later runs prefer cache to generate Query / Body / FormData mock data',
